...
class SecondStarterScreen extends StatefulWidget {
  const SecondStarterScreen({super.key});

  @override
  State<SecondStarterScreen> createState() => _SecondStarterScreenState();
}

class _SecondStarterScreenState extends State<SecondStarterScreen> with SingleTickerProviderStateMixin {
